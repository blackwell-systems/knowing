...
- **24 CLI commands**: serve, index, query, export, diff, context, why, mcp, watch, reindex, init, add, remove, list, test-scope, ingest-scip, enrich, fsck, prove, verify, prove-absent, audit, audit-diff, version
...
- [CLI Reference](guide/cli.md): all 24 commands with flags and examples
