...
- **19 CLI commands**: serve, index, query, export, diff, context, why, mcp, watch, reindex, init, add, remove, list, test-scope, ingest-scip, enrich, fsck, version
...
- [CLI Reference](guide/cli.md): all 19 commands with flags and examples
