...
- **23 CLI commands**: serve, index, query, export, diff, context, why, mcp, watch, reindex, init, add, remove, list, test-scope, ingest-scip, enrich, fsck, prove, verify, audit, audit-diff, version
...
- [CLI Reference](guide/cli.md): all 23 commands with flags and examples
