...
| 17a | **Gap-fill threshold tuning** | Current threshold is < 5 candidates. Test < 3 (conservative) and < 8 (aggressive). Also test seed cap: currently fills to 15, try 10 and 20. Quick A/B on django (~30s each). | To test |
