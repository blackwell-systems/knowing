...
| 13 | **Re-test enriched saleor with exponent 0.3** | Previous: enriched+0.5 = 0.209 (unenriched = 0.236). Exponent 0.3 is gentler on enriched repos (sweep showed 11/15 enriched repos improved). If enrichment becomes net-positive on saleor, enrich it in corpus. Quick experiment, 20 min. | Low | Enrichment story |
