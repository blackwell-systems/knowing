...
| [cross-system](cross-system/) | Graph retrieval beats text search and all competitors across languages and scales | 7 repos, 117 tasks, 7 competitors. knowing P@10=0.217 vs codegraph 0.133 (1.63x) vs codebase-memory 0.137 (1.51x) vs Aider 0.050 (4.3x) vs GitNexus 0.076 (2.9x) vs grep 0.020 (11x). |
