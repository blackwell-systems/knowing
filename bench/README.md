...
| [cross-system](cross-system/) | Graph retrieval beats text search and all competitors across languages and scales | 7 repos, 117 tasks, 7 competitors. knowing P@10=0.185 vs codegraph 0.135 (1.36x) vs GitNexus 0.075 (2.45x) vs Gortex 0.063 (2.92x) vs grep 0.013 (14.2x). Docstring FTS + 32 edge types. |
