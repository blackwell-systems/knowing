...
| [cross-system](cross-system/) | Graph retrieval beats text search and all competitors across languages and scales | 9 repos, 167 tasks, 7 competitors. knowing P@10=0.210 vs codegraph 0.135 (1.56x) vs GitNexus 0.075 (2.80x) vs Gortex 0.063 (3.33x) vs grep 0.013 (16.2x). Docstring FTS + 34 edge types. |
