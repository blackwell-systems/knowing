...
| [cross-system](cross-system/) | Graph retrieval beats text search and all competitors across languages and scales | 15 repos, 297 tasks, 7 competitors. knowing P@10=0.278 vs codegraph 0.087 (3.20x) vs GitNexus 0.055 (5.05x) vs Gortex 0.052 (5.35x) vs grep 0.015 (18.5x). Focused seed selection + cluster-aware gap-fill + 38 edge types. |
