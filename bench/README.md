...
| [cross-system](cross-system/) | Graph retrieval beats text search and all competitors across languages and scales | 14 repos, 277 tasks, 7 competitors. knowing P@10=0.189 vs codegraph 0.087 (2.17x) vs GitNexus 0.055 (3.44x) vs Gortex 0.052 (3.63x) vs grep 0.015 (12.6x). Focused seed selection + cluster-aware gap-fill + 38 edge types. |
