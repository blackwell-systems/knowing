...
| [cross-system](cross-system/) | Graph retrieval beats text search and all competitors across languages and scales | 7 repos, 161 tasks, 7 competitors. knowing P@10=0.202 vs codegraph 0.135 (1.50x) vs GitNexus 0.075 (2.69x) vs Gortex 0.063 (3.21x) vs grep 0.013 (15.5x). Docstring FTS + 32 edge types. |
