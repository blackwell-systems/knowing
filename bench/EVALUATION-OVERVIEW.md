...
**Harness:** `bench/cross-system/` (308 tasks, 16 repos, 8 languages, cold start)
...
**Verdict:** Quality compounds with usage. Cold-start floor is 0.281, compounded with
...
2. **Cold-start floor.** Feedback compounding requires usage. First-run precision is 0.281. Compounding improves this over time but requires similar queries.
...
| 31 | 2026-06-01 | FTS decomposition, per-cluster feedback, LSP attenuation | 0.281 | Session 25 (16 repos, 308 tasks) |
| 32 | 2026-06-02 | Cross-task vocab validation, confidence weighting | 0.281 | Session 26 (vocab neutral on aggregate, +41% Django) |
