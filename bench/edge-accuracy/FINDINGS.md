...
| Metric | Count | Rate |
|--------|-------|------|
| Tree-sitter edges (ast_inferred) | 9976 | - |
| Go/ast edges (ast_resolved) | 23092 | - |
| Confirmed (in both) | 2661 | 26.7% of inferred |
| Inferred-only (potential FP) | 7315 | 73.3% of inferred |
| Resolved-only (missed) | 20431 | 88.5% of resolved |

## Per-Edge-Type Breakdown

| Edge Type | Tree-sitter | Go/ast | Confirmed | FP Rate | Miss Rate |
|-----------|-------------|--------|-----------|---------|----------|
| calls | 9164 | 3487 | 24.3% | 75.7% | 36.2% |
| imports | 812 | 437 | 53.6% | 46.4% | 0.5% |
| implements | 0 | 5 | 0.0% | 0.0% | 100.0% |
| references | 0 | 19163 | 0.0% | 0.0% | 100.0% |
...
| Metric | Count | Rate |
|--------|-------|------|
| Tree-sitter edges | 9976 | - |
| Go/ast edges | 3924 | - |
| Confirmed | 2661 | 26.7% of inferred |
| Inferred-only (FP) | 7315 | 73.3% of inferred |
| Resolved-only (missed) | 1263 | 32.2% of resolved |
...
The 26.7% confirmation rate for calls+imports means tree-sitter provides
