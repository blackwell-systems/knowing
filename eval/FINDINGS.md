...
| Add a method to SQLiteStore that queries nodes by communi... | 80.0% | 133.3% | 0.33 | easy |
...
| Add full-text search to the store layer for finding nodes... | 80.0% | 200.0% | 0.50 | easy |
...
| Fix keyword extraction logic in the context engine | 20.0% | 66.7% | 0.33 | easy |
...
| Query edges coming into and out of a node in the store | 50.0% | 125.0% | 0.33 | easy |
...
| Pack ranked symbols into a token budget for the context w... | 30.0% | 75.0% | 0.50 | easy |
...
| Implement HITS hub/authority reranking in the context eng... | 30.0% | 37.5% | 0.33 | medium |
...
| Ingest production telemetry traces, resolve span names to... | 10.0% | 12.5% | 0.20 | hard |
